...
class CpuGpuOffloadingHandlers:
    def __init__(
        ...
        for layer_name, gpu_tensor in gpu_caches.items():
            ...
            # NOTE: gpu_tensor.shape is in LOGICAL order (the tensor was
            # permuted back via inv_order in _reshape_kv_cache_tensors),
            # so we should NOT apply kv_cache_stride_order to test_shape.
            # The test_shape from get_kv_cache_shape is already in logical
            # order, matching gpu_tensor.shape.
